...
**a. Dot believes the Goodfeathers show up about 8 times per hour on average, with a standard deviation of 0.5 appearances. Tune and plot an appropriate Gamma(s, r) prior model for λ.**
...
**e. Comment on how Brain's understanding of μ evolved from the prior to the posterior based on Pinky's observed data. Did the stock perform as well as Brain had hoped?**
